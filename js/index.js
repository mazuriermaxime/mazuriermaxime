...
Lorsqu'une erreur est détectée, l'utilisateur doit en être informé grâce à l'affichage 
...
if (erreur) {
    ...
    alert('Formaulaire envoyé');
} */

document.getElementById('submitbtn').addEventListener('click', function verif(e) {
...
var sexe2 = document.getElementById("sexe2").checked;
var sexe3 = document.getElementById("sexe3").checked;
var date = document.getElementById("date").value;
var codepostal = document.getElementById("codeP").value;
var adresse = document.getElementById("Adresse").value;
var ville = document.getElementById("ville").value;
var email = document.getElementById("email").value;
var sujet = document.getElementById("examplesujet").value;
var accept = document.getElementById("submitbtn").checked;
var question = document.getElementById("examplequestion").value;